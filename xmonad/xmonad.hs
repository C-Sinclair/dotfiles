...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm,  xK_q), kill) -- mod + q

    -- GAPS!!!
    , ((modm, xK_f), sendMessage $ ToggleGaps) -- mod + f -- fullscreen
...
------------------------------------------------------------------------
-- Gaps
myLayoutHook = gaps [(L,30), (R,30), (U,40), (D,60)] $ spacingRaw True (Border 10 10 10 10) True (Border 10 10 10 10) True $ smartBorders $ myLayout
